...
class HubspotController extends Controller {
	...
	/*public function getImportDeals() {
		...
		foreach($items as $item){
	        ...
	        $main_array = \Staff::importHubspotProperty($properties, $array);
		...
		\Staff::generateDeal($main_array, $main_array['id'], $company_ids, $contact_ids);
		return ['created'=>true];
	}*/
	...
	/*public function postDealCreated($id) {
		...
		\Staff::generateDeal($main_array, $id, $company_ids, $contact_ids);
		return ['created'=>true];
	}*/

	// Export Company to HubSpot
	public static function exportCompanyCreated($id) {
		$item = \Solunes\Staff\App\Company::find($id);
        $array = $this->company_fields;
	...
	public static function exportContactCreated($id) {
		$item = \Solunes\Staff\App\Contact::find($id);
        $array = $this->contact_fields;
	...
	/*public static function exportDealCreated($id) {
		$item = \Solunes\Staff\App\Deal::find($id);
		\Staff::exportDeal($item);
		return ['created'=>true];
	}*/
	...
	public function initiateHubspot() {
		$hubspot = \SevenShores\Hubspot\Factory::create(config('staff.hubspot_api_key'));
		return $hubspot;
	}
